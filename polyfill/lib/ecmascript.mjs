...
export const ES = ObjectAssign({}, ES2020, {
  ...
  ToTemporalDateTime: (item, options = ObjectCreate(null) /* FIXME */) => {
  ...
  ToTemporalZonedDateTime: (item, options = ObjectCreate(null) /* FIXME */) => {
  ...
  AddDuration: (
    ...
    if (!relativeTo) {
      ...
      const dateAdd = ES.GetMethod(calendar, 'dateAdd');
      const intermediate = ES.CalendarDateAdd(calendar, datePart, dateDuration1, undefined, dateAdd);
